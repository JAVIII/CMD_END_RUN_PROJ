...
import curses
import ConfigParser
from serverLevel import LevelGen
from serverMenu import menu
...
gameMenu = menu(menuFile, hScoreFile, gameOverFile, waitingFile, server,  stdscr)
...
while True:  # return to menu until user chooses to quit
    ...
    #menuChoice = seed for levelGen
        ...
        gridMaker = LevelGen(grid, height, width, menuChoice, server, stdscr)  # Initialize the game
